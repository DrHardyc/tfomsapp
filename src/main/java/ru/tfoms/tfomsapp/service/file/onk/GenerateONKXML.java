    ...
    public void generate(String dirName){
        ...
        for (int i = 0; i < 10; i++) {
            ...
            Element pacient = new Element("PACIENT");
                ...
                smoogrn.appendChild("smoogrn | " + random.nextInt(9999));
                pacient.appendChild(smoogrn);
                Element smook = new Element("SMO_OK");
                smook.appendChild("smook | " + random.nextInt(9999));
            ...
            Element zsl = new Element("Z_SL");
                ...
                for (int iSl = 0; iSl < 2; iSl++){
                    ...
                    dsonk.appendChild("dsonk | " + random.nextInt(99));
                    ...
                    for (int iUsl = 0; iUsl < 2; iUsl++){
                        ...
                        codemd.appendChild("codemd | " + random.nextInt(99999));
                        usl.appendChild(codemd);
